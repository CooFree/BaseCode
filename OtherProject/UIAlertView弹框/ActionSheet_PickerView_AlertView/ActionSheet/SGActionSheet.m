...
#define kTableLineColor [UIColor colorWithRed:(226/255.0) green:(226/255.0) blue:(226/255.0) alpha:1.0]
...
- (void)setupSubviews {
    ...
    if (_message_label.text) {
        ...
        splitters.backgroundColor=kTableLineColor;
...
//        _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    ...
    UIView *line=[[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMinY(_cancelButton.frame)-margin_cancelButton_to_otherButton, SG_screenWidth, margin_cancelButton_to_otherButton)];
...
- (void)show {
    ...
    [UIView animateWithDuration:SheetViewAnimationDuration animations:^{
        self.sheetView.transform = CGAffineTransformMakeTranslation(0, - self.sheetView.frame.size.height);
    }];
}
...
//        _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
        ...
        UIView *line=[[UIView alloc]initWithFrame:CGRectMake(0, message_bgViewHeight + tableViewHeight, SG_screenWidth, margin_cancelButton_to_otherButton)];
        line.backgroundColor=kTableLineColor;
        [self.sheetView addSubview:line];
    }
    [self.coverView addSubview:_sheetView];
